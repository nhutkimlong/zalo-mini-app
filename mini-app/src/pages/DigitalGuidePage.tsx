...
export const DigitalGuidePage: React.FC = () => {
  ...
  return (
    <Page>
      ...
      <div className={cx(styles, "guide-container")}>
        <div className={cx(styles, "glass-card guide-intro-card")}>
          <Volume2 size={18} style={{ color: "var(--site-gold)", flexShrink: 0, marginTop: "2px" }} />
          <p className={cx(styles, "guide-intro-text")}>
            {language === "km"
        ...
        {/* Audio Guides List */}
        <div className={cx(styles, "guide-list")}>
          {loading ? (
            ...
            return audioPlaces.map((place, index) => {
              ...
              return (
                <div 
                  key={place.id}
                  className={cx(styles, "glass-card guide-card-item fade-in-up")}
                  style={{
                ...
                >
                  {(() => {
                    ...
                    return (
                      <>
                        <div className={cx(styles, "guide-card-left")}>
                          <div className={cx(styles, `guide-icon-circle ${hasAudio ? "has-audio" : "no-audio"}`)}>
                        ...
                        {hasAudio ? (
                          <Link 
                            ...
                            className={cx(styles, "guide-play-btn")}
                          ...
                          <span className={cx(styles, "guide-no-audio-badge")}>
