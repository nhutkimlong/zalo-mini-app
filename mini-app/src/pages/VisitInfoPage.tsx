        ...
        return ticketSections.map(section => ({
          ...
          items: (section.items || []).map((item: any) => ({
            ...
            price: (() => {
              ...
              if (lang === "en" && p.toLowerCase().includes("mi�…n phí")) return "Free";
              return p;
            })(),
  ...
  for (const line of lines) {
    ...
    if (
      ...
      if (lowerTitle.includes("vân sơn") || lowerTitle.includes("van son")) {
        title = lang === "en" ? "Van Son Cable Route (To the Peak)" : "Tuyến cáp Vân Sơn (Lên �‘ỉnh núi)";
    ...
    if (trimmed.startsWith("-") || trimmed.startsWith("*") || /^\d+\./.test(trimmed)) {
      ...
      if (parts.length >= 2) {
        ...
        } else if (/mi�…n phí|free|mien phi/i.test(price)) {
          price = lang === "en" ? "Free" : "Mi�…n phí";
        }
  ...
  return (
    <Page>
      ...
      <div className="custom-tabs">
        ...
        >
          {language === "en" ? "Tickets & Hours" : "Vé & Lịch hoạt �‘ộng"}
        </button>
        <button 
          ...
          {ticketsLoading ? (
            ...
            <div className="glass-card" style={{ textAlign: "center", padding: "32px 16px" }}>
              ...
              <p style={{ color: "var(--light-text)", fontSize: "14px", margin: 0 }}>
                {language === "en" ? "Ticket information is being updated. Please check back soon." : "Thông tin vé �‘ang �‘ược cập nhật. Vui lòng quay lại sau."}
              </p>
            </div>
          ) : (
                  ...
                  <table style={{ width: "100%", fontSize: "13.5px", borderCollapse: "collapse" }}>
                    <thead>
                      <tr style={{ borderBottom: "1px solid rgba(0,0,0,0.1)", textAlign: "left", color: "var(--light-text)" }}>
                        <th style={{ padding: "6px 0" }}>{language === "en" ? "Visitor Category" : "Đ�‘i tượng"}</th>
                        <th style={{ padding: "6px 0" }}>{hasOneway ? (language === "en" ? "Round-trip" : "Giá khứ h�“i") : (language === "en" ? "Round-trip Price" : "Giá vé khứ h�“i")}</th>
                        {hasOneway && (
                    ...
                    <tbody>
                      {section.items.map((item, iIdx) => {
                        const isFree = item.price.toLowerCase().includes("mi�…n phí") || item.price.toLowerCase().includes("free") || item.price.toLowerCase().includes("mien phi");
                        return (
        ...
        <div style={{ padding: "0 16px", display: "flex", flexDirection: "column", gap: "16px" }}>
          {ticketsLoading ? (
            ...
            <div className="glass-card" style={{ textAlign: "center", padding: "32px 16px" }}>
              ...
              <p style={{ color: "var(--light-text)", fontSize: "14px", margin: 0 }}>
                {language === "en" ? "Travel guide is being updated. Please check back soon." : "Hướng dẫn di chuyển �‘ang �‘ược cập nhật. Vui lòng quay lại sau."}
              </p>
            </div>
          ) : (
        ...
        <div style={{ padding: "0 16px", display: "flex", flexDirection: "column", gap: "16px" }}>
          {ticketsLoading ? (
            ...
            <div className="glass-card" style={{ textAlign: "center", padding: "32px 16px" }}>
              ...
              <p style={{ color: "var(--light-text)", fontSize: "14px", margin: 0 }}>
                {language === "en" ? "Rules & etiquette information is being updated." : "Thông tin nội quy �‘ang �‘ược cập nhật. Vui lòng quay lại sau."}
              </p>
            </div>
          ) : (
