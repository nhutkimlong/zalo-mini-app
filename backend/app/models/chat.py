...
class UserInfo(BaseModel):
    zalo_user_id: Optional[str] = Field(None, description="ID người dùng từ hệ thống Zalo")
...
class ChatRequest(BaseModel):
    ...
    user_info: Optional[UserInfo] = Field(None, description="Thông tin chi tiết người dùng Zalo")
